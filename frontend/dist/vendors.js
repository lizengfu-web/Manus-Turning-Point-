...
function useStore(api, selector = identity, equalityFn) {
  if (( true ? {"NODE_ENV":"development"}.MODE : 0) !== "production" && equalityFn && !didWarnAboutEqualityFn) {
    console.warn(
...
const createImpl = (createState) => {
  if (( true ? {"NODE_ENV":"development"}.MODE : 0) !== "production" && typeof createState !== "function") {
    console.warn(
...
var react = (createState) => {
  if (( true ? {"NODE_ENV":"development"}.MODE : 0) !== "production") {
    console.warn(
